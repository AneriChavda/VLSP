...
public class NetIFStatsReporter implements Reporter, RouterDeletedNotification, TrafficInfo {
    ...
    public List<Object> getTraffic(String routerSrc, String routerDst) {
        ...
        if (tablePrev == null) {
            ...
            if (rowPrev == null) {
                ...
                // OutErrors | OutDropped | OutDataBytes | OutDataPackets | InQueue | BiggestInQueue | OutQueue | BiggestOutQueue |
                // Router-1 localnet | 2548 | 13 | 0 | 0 | 2548 | 13 | 10584 | 54 | 0 | 0 | 10584 | 54 | 0 | 1 | 0 | 0 |
                ...
                for (int pos = 1; pos<row.size(); pos++) {
                    ...
                    if (prevValue > currentValue) {
                        // a data oddity
                        System.err.println("Data error: " + row.get(0) + " previous valueof " + table.getColumnDefinitions().get(
                                               pos).getName() + " = " + prevValue + " > current value: " + currentValue );
                    } else {
     ...
     */
    protected long calculateTraffic(Table table) {
        if (table == null) {
            return 0;
        } else {
            long volume = 0;
    ...
    protected long calculateTotalTraffic() {
        ...
        System.out.println("NetIFStatsReporter: Total volume = " + volume);
        ...
        System.out.println("NetIFStatsReporter: Total lost = " + lost);
