...
public class WebServer extends NanoHTTPD {
    ...
    public Response serve( String uri, String method, Properties header, Properties parms, Properties files ) {
        ...
        if (uri.equals("/GRAPH")) {
            ...
            if (viewer == null) {
                ...
                System.err.println("WebServer: About to get snapshot " + (value == null ? "LATEST" : value));
                ...
                response = new NanoHTTPD.Response( HTTP_OK, MIME_HTML, msg );
                response.addHeader("Set-Cookie", "xdot="+viewer.getSnapshotNumber());
    ...
    public Response serveFile( String uri, Properties header, File homeDir, boolean allowDirectoryListing ) {
        return super.serveFile(uri, header,  new File("demo_usr/canviz/"), true );
    }
